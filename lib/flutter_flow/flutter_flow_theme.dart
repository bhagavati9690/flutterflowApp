...
abstract class FlutterFlowTheme {
  ...
  late Color lemonLime;
  late Color mindaro;
  late Color sunglow;
  late Color yellow;
  late Color tangerine;
  late Color clbxBlack;
  late Color clbxIconColor1;
  late Color clbxIcon2;
  late Color clbxBackground;
  late Color clbxBackgroundColor;
  late Color clbxButtonColor;
  late Color pillColor;
  late Color pillColor2;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF1E09E3);
  ...
  late Color lemonLime = const Color(0xFFE3F333);
  late Color mindaro = const Color(0xFFFCFEEB);
  late Color sunglow = const Color(0xFFFCD146);
  late Color yellow = const Color(0xFFFFFD15);
  late Color tangerine = const Color(0xFFF48705);
  late Color clbxBlack = const Color(0xFF111111);
  late Color clbxIconColor1 = const Color(0xFF787D7F);
  late Color clbxIcon2 = const Color(0xFF0E0EDD);
  late Color clbxBackground = const Color(0xFFE0E3E7);
  late Color clbxBackgroundColor = const Color(0xFF73EBE1);
  late Color clbxButtonColor = const Color(0xFF225956);
  late Color pillColor = const Color(0xFF808000);
  late Color pillColor2 = const Color(0xFFD2E030);
}
