...
import '/index.dart';
import 'family_member_form_widget.dart' show FamilyMemberFormWidget;
import 'package:expandable/expandable.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';

class FamilyMemberFormModel extends FlutterFlowModel<FamilyMemberFormWidget> {
  ...
  // Stores action output result for [Backend Call - API (familyMemberEdit)] action in FamilyMemberForm widget.
  ...
  String? _firstNameTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'q998jsbk' /* FirstName is  required */,
      );
    }
  ...
  // Stores action output result for [Backend Call - API (myfamilyAddressesSuggestion)] action in Adress widget.
  ApiCallResponse? apiResultAdressSuggestion;
  // Stores action output result for [Backend Call - API (myfamilyPopulateAddress)] action in Adress widget.
  ApiCallResponse? apiResultPoulateAddress1;
  // Stores action output result for [Backend Call - API (myfamilyPopulateAddress)] action in Row widget.
