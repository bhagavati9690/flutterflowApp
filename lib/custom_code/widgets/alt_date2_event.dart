...
class AltDate2Event extends StatefulWidget {
  const AltDate2Event({
    super.key,
    this.width,
    this.height,
  ...
  @override
  State<AltDate2Event> createState() => _CustomCalendarState();
}

class _CustomCalendarState extends State<AltDate2Event> {
