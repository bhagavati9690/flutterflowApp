...
class ItemAltDate1 extends StatefulWidget {
  const ItemAltDate1({
    super.key,
    this.width,
    this.height,
  ...
  @override
  State<ItemAltDate1> createState() => _CustomCalendarState();
}

class _CustomCalendarState extends State<ItemAltDate1> {
  ...
  void initState() {
    super.initState();
    _focusedDay = widget.preselectedDate ?? DateTime.now();
    _selectedDay = widget.preselectedDate; // Set the initial selected day
    if (widget.preselectedDate != null) {
      _updateFlutterFlowState(widget.preselectedDate ?? DateTime.now());
    }
  }
