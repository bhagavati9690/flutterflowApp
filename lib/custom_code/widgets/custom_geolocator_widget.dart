...
class CustomGeolocatorWidget extends StatefulWidget {
  const CustomGeolocatorWidget({
    super.key,
    this.width,
    this.height,
  });
  ...
  @override
  State<CustomGeolocatorWidget> createState() => _CustomGeolocatorWidgetState();
}
...
class _CustomGeolocatorWidgetState extends State<CustomGeolocatorWidget> {
  ...
  Widget build(BuildContext context) {
    print('List contains items: ${_positionItems.isNotEmpty}');
  ...
  void _toggleServiceStatusStream() {
    if (!kIsWeb && _serviceStatusStreamSubscription == null) {
