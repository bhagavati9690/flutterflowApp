...
class CustomChoiceChipsTwo extends StatefulWidget {
  const CustomChoiceChipsTwo({
    super.key,
    this.width,
    this.height,
  ...
  @override
  State<CustomChoiceChipsTwo> createState() => _CustomChoiceChipsState();
}

class _CustomChoiceChipsState extends State<CustomChoiceChipsTwo> {
  int? selectedIndex;
  @override
  void initState() {
    super.initState();
    ...
    if (widget.initialValue != null) {
      setState(() {
        ...
        FFAppState().customChoiceChipSelection2 = selectedIndex.toString();
      });
    }
  }
            ...
            return ChoiceChip(
              ...
              onSelected: (bool selected) {
                setState(() {
                  ...
                  FFAppState().customChoiceChipSelection2 =
