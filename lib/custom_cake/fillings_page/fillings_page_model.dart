...
import '/index.dart';
import 'fillings_page_widget.dart' show FillingsPageWidget;
import 'package:flutter/material.dart';

class FillingsPageModel extends FlutterFlowModel<FillingsPageWidget> {
  ...
  // Stores action output result for [Backend Call - API (cakeFillings)] action in fillingsPage widget.
  ApiCallResponse? cakeFlavourResponse;
  // Stores action output result for [Backend Call - API (fillingListPickerCursor)] action in fillingsPage widget.
  ApiCallResponse? flavourOptionsResponse;
  // Stores action output result for [Backend Call - API (fillingsCheckboxSelection)] action in Icon widget.
  ApiCallResponse? checkboxChanged;
  // Stores action output result for [Backend Call - API (fillingsCheckboxSelection)] action in Icon widget.
  ApiCallResponse? checkboxChanged2;
  // Stores action output result for [Backend Call - API (fillingsCheckboxSelection)] action in Container widget.
  ApiCallResponse? checkboxChanged3;
  // Stores action output result for [Backend Call - API (fillingsNext)] action in Button widget.
