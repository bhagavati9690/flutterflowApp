...
import 'color_page_model.dart';
export 'color_page_model.dart';

class ColorPageWidget extends StatefulWidget {
  const ColorPageWidget({
    super.key,
  ...
  static String routeName = 'colorPage';
  static String routePath = 'colorPage';

  @override
  State<ColorPageWidget> createState() => _ColorPageWidgetState();
}

class _ColorPageWidgetState extends State<ColorPageWidget> {
  late ColorPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ColorPageModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.cakeFlavourResponse = await CustomCakeTwoGroup.cakeColourCall.call(
        clientState:
      ...
      if ((_model.cakeFlavourResponse?.succeeded ?? true)) {
        _model.ocKey = CustomCakeTwoGroup.cakeColourCall.id(
      ...
      _model.flavourOptionsResponse =
          await CustomCakeTwoGroup.colorListPickerCall.call(
        uiContext:
            '{\"key\":\"cakeColorTab\",\"clientId\":\"customCakeForMenuSectionToCart__customCakeCartWizardTabPanel\",\"index\":7,\"staticTabs\":[{\"tabName\":\"cakeFlavours\",\"recordKey\":\"2611\",\"parentRecordKey\":\"-1\",\"index\":\"0\"},{\"tabName\":\"cakeFillings\",\"recordKey\":\"2611\",\"parentRecordKey\":\"-1\",\"index\":\"0\"},{\"tabName\":\"cakeIcingsTab\",\"recordKey\":\"2611\",\"parentRecordKey\":\"-1\",\"index\":\"0\"},{\"tabName\":\"cakeShapesTab\",\"recordKey\":\"2611\",\"parentRecordKey\":\"-1\",\"index\":\"${widget.index}\"}]}',
                      ...
                      child: Row(
                        ...
                        children: [
                          FFButtonWidget(
                            onPressed: () async {
                              _model.nextResponse =
                                  await CustomCakeTwoGroup.colorNextCall.call(
                                clientState:
                                    '{\"clientId\":\"contains_cakeColorTab__cakeColorTab__cakeColorUIForm\",\"cursor\":{\"recordKey\":\"-1\",\"parentRecordKey\":\"${widget.parentRecordKey}\",\"index\":\"${widget.index}\",\"__cachedId\":\"${_model.ocKey}\"}}',
                                recordKey: widget.recordKey,
                                parentRecordKey: widget.parentRecordKey,
                                index: widget.index,
                                id: _model.ocKey,
                              ...
                              if ((_model.nextResponse?.succeeded ?? true)) {
                                _model.nextParams = functions
                                    .mapParams(CustomCakeTwoGroup.colorNextCall
                                        .act(
