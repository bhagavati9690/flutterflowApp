...
import '/index.dart';
import 'entertainer_package_widget.dart' show EntertainerPackageWidget;
import 'package:flutter/material.dart';

class EntertainerPackageModel
    extends FlutterFlowModel<EntertainerPackageWidget> {
  ...
  // Stores action output result for [Backend Call - API (entertainerPackage)] action in EntertainerPackage widget.
  ApiCallResponse? entertainerPackageOuput;
