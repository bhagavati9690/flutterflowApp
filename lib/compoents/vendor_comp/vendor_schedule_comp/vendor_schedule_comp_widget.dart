...
import 'vendor_schedule_comp_model.dart';
export 'vendor_schedule_comp_model.dart';

class VendorScheduleCompWidget extends StatefulWidget {
  const VendorScheduleCompWidget({
    super.key,
  ...
  @override
  State<VendorScheduleCompWidget> createState() =>
      _VendorScheduleCompWidgetState();
}

class _VendorScheduleCompWidgetState extends State<VendorScheduleCompWidget> {
  late VendorScheduleCompModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VendorScheduleCompModel());
                  ...
                  Builder(
                    builder: (context) => FFButtonWidget(
                      onPressed: () async {
                        ...
                        if ((_model
                                .submissionDateListPickerResponse?.succeeded ??
                            true)) {
                          await showDialog(
                            context: context,
