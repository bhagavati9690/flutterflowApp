...
import 'cake_search_comp_model.dart';
export 'cake_search_comp_model.dart';

class CakeSearchCompWidget extends StatefulWidget {
  const CakeSearchCompWidget({super.key});

  @override
  State<CakeSearchCompWidget> createState() => _CakeSearchCompWidgetState();
}

class _CakeSearchCompWidgetState extends State<CakeSearchCompWidget> {
  late CakeSearchCompModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CakeSearchCompModel());
            ...
            child: Column(
              ...
              children: [
                        ...
                        child: Visibility(
                          ...
                          child: FutureBuilder<ApiCallResponse>(
                            future: (_model.apiRequestCompleter ??= Completer<
                                    ApiCallResponse>()
                                  ..complete(CakeGroup.cakeSuggestionCall.call(
                ...
                FutureBuilder<ApiCallResponse>(
                  future: CakeGroup.cakeThemesCall.call(),
                  builder: (context, snapshot) {
                    // Customize what your widget looks like when it's loading.
                    if (!snapshot.hasData) {
                      return Center(
                    ...
                    final rowCakeThemesResponse = snapshot.data!;

                    return Row(
                      mainAxisSize: MainAxisSize.max,
                      children: [
                        if (rowCakeThemesResponse.succeeded == true)
                          Flexible(
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  12.0, 0.0, 12.0, 0.0),
                              child: FlutterFlowDropDown<String>(
                                controller: _model.catagoryValueController ??=
                                  ...
                                  _model.catagoryValue ??=
                                      CakeGroup.cakeThemesCall
                                          .id(
                                            rowCakeThemesResponse.jsonBody,
                                          )
                                          ?.firstOrNull,
                                ),
                                options: List<String>.from(
                                    CakeGroup.cakeThemesCall.id(
                                  rowCakeThemesResponse.jsonBody,
                                )!),
                                ...
                                hintText: FFLocalizations.of(context).getText(
                                  'b8hebhxt' /* e.g. First Birthday, Cakes etc... */,
                                ),
                                icon: Icon(
